...
| `viewer-light-theme.png` | The same trace in the light theme — shown automatically when the OS prefers light (`prefers-color-scheme`); the header toggle overrides the OS either way. |
